...
import KR from "./assets/Krishna Rupavatharam MSU Spectrum Lab.png"

export default function KeynoteBanner() {
  return (
    <div className='grid grid-cols-4 gap-3'>
        <h2 className='col-span-4 uppercase text-4xl mb-0'>
            Keynote Speakers
        </h2>
        <div className='mt-4 bg-transparent-blue-10 backdrop-blur-lg rounded-3xl p-4 col-span-4 sm:col-span-4 lg:col-span-1 grid justify-items-center sm:justify-items-start lg:justify-items-center grid-cols-1 gap-0 sm:grid-cols-3 lg:grid-cols-1 '>
        ...
        <div className='mt-4 bg-transparent-blue-10 backdrop-blur-lg rounded-3xl p-4 col-span-4 sm:col-span-4 lg:col-span-1 grid justify-items-center sm:justify-items-start lg:justify-items-center grid-cols-1 gap-0 sm:grid-cols-3 lg:grid-cols-1 '>
            ...
            <div className='col-span-2'>
                ...
                <p className='text-bright-purple text-center sm:text-start lg:text-center font-[100]'>Krishna Rupavatharam is the director of Spectrum Lab which advances the opto-electronic technologies emerging from the research laboratories of Montana State University and foster their transition to Montana companies and provides enhanced educational opportunities for undergraduate and graduate students.</p>
            </div>
        </div>
    </div>
