  ...
  return (
    <div className="main">
      ...
      <div className='events' id="events">
        ...
        subHead={"Highlighted guest speakers include:"} subDescription={"Gov. Gianforte, Senators John Tester and Steve Daines, Director Scott Osterman \n Bob Sutor, author Dancing with Qubits \n Futurist and speaker on the creative intersection of technology & business and fostering the next generation innovators."}/>
        ...
        subHead={"Join us for:"} subDescription={"Origin Stories: Commercializing disruptive technologies – Business Showcase panel with 4 successful Montana tech firms in photonics, bio, and quantum \n The Promise of Quantum for Interdisciplinary Discoveries  \n Q&A Roundtable: U.S. federal investments in quantum capabilities with DARPA, NSF, and NIH SBIR Program leaders."}/>
